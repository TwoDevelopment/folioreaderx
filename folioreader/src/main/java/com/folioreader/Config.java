...
public class Config implements Parcelable {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        bundle.putBoolean(CONFIG_IS_ACTION_SHARE,actionShare);
    ...
    protected Config(Parcel in) {
        try {
            ...
            if (bundle == null) {
                ...
                actionShare = getBundleItem(bundle, CONFIG_IS_ACTION_SHARE, actionShare);
    ...
    public Config(JSONObject obj) {
        ...
        actionShare = getJsonItem(obj, CONFIG_IS_ACTION_SHARE, true);
        allowedDirection = getAllowedDirectionFromString(
                LOG_TAG,
